# survey_vita-utterance-assistant-memory-personalisation

Bước 1 của pipeline Vita: persona diễn đạt lại các câu lệnh mẫu theo giọng riêng.

- **Nguồn**: `Dataset - Vita Demo`, intent `assistant_memory_personalisation`
...
uv run python scripts/generate_vita_utterance_tasks.py \
  ...
  --intent assistant_memory_personalisation --force
```
